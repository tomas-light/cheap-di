import { container } from '../ContainerImpl.js';
...
describe('arguments order', () => {
  ...
  test('case 2', () => {
    @inject(Repository, 'unknown', Database)
  ...
  test('case 3', () => {
    @inject('unknown', Repository, Database)
  ...
  test('case 4', () => {
    @inject('unknown', Repository, 'unknown', Database)
  ...
  test('case 6', () => {
    ...
    @inject('unknown', Repository, Config, 'unknown', Database, AnotherService)
